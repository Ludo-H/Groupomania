        ...
        <div className="modify-infos">
            ...
            {inputDisplay &&
              <Fragment>
                ...
                <input type="text" name="firstname" id="profil-firstname" value={firstname}  onChange={(e)=> setFirstName(e.target.value)}/>

                <label htmlFor="profil-lastname">Nom</label>
                <input type="text" name="lastname" id="profil-lastname" value={lastname} onChange={(e)=> setLastName(e.target.value)}/>
